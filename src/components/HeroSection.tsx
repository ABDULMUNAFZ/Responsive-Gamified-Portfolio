    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-6xl mx-auto text-center" ref={magneticRef}>
          ...
          {/* CTA Buttons */}
          <div ref={ctaRef} className="flex flex-wrap items-center justify-center gap-5 mb-14">
            <a
              href="#projects"
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-gradient-orange to-gradient-crimson opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </a>
            <a
              href="#contact"
